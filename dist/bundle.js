...
var buttonShowElement = document.getElementById("Show1Button");
buttonShowElement.addEventListener("click", showOne);
function showOne() {
    var output = document.getElementById("contentDelete");
    var inputElement = document.getElementById("Show1Input");
    var uri = "https://restexamdll.azurewebsites.net/api/projects/";
    console.log(uri + inputElement.value);
    _node_modules_axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri + inputElement.value)
        .then(function (response) {
        var result = "<table style=\"width:100%\"> <tr> <th>ID</th> <th>Name</th> <th>Category</th> <th>Points</th> </tr>";
        var mes;
...
function showAll() {
    ...
    _node_modules_axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri)
        .then(function (response) {
        var result = "<table style=\"width:100%\"> <tr> <th>ID</th> <th>Name</th> <th>Cathegory</th> <th>Points</th> </tr> ";
...
function deleteM() {
    ...
    var uri = "https://restexamdll.azurewebsites.net/api/projects" + id;
    _node_modules_axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(uri)
        .then(function (response) {
